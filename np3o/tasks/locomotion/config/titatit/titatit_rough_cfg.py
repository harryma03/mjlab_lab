...
"""TITATIT rough task config (D1 rough terrain layout).
...
def _titatit_rough_cost_terms() -> dict:
    """Return cost terms for TITATIT NP3O constrained training.
...
# ---------------------------------------------------------------------------
# Rough terrain: independent copy of the D1 rough layout
# ---------------------------------------------------------------------------
...
# ===========================================================================
# 4. TITATIT rough environment
# ===========================================================================


def titatit_rough_env_cfg(
    num_envs: int = 4096,
    play: bool = False,
    ...
    cfg.cost_terms = _titatit_rough_cost_terms()

    return cfg


def titatit_rough_play_env_cfg(
    num_envs: int = 50,
    flatten_policy_history: bool = False,
) -> ManagerBasedRlEnvCfg:
    """Convenience wrapper: TITATIT rough play config (noise/randomization disabled)."""
    return titatit_rough_env_cfg(num_envs=num_envs, play=True, flatten_policy_history=flatten_policy_history)
